...
public class SceneSwitchService {
    ...
    public void switchToLoginView(ActionEvent actionEvent) throws IOException {
        // load layout of scene
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/example/frontendjavafx/fxml/login-view.fxml"));
    ...
    public void switchToRegistrationView(ActionEvent actionEvent) throws IOException {
        // load layout of scene
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/example/frontendjavafx/fxml/registration-view.fxml"));
